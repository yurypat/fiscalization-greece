...
namespace Mews.Fiscalization.Greece.Model
{
    ...
    {
        public InvoiceSummary(Amount totalNetValue, Amount totalVatAmount, Amount totalGrossValue, IEnumerable<ItemIncomeClassification> invoiceRecordIncomeClassification)
        {
